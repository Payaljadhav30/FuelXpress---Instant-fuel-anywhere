    ...
    <div className="shadow-lg gap-3 rounded m-8 p-8 flex bg-gray-800">
      <div className="lg:md:flex flex-col gap-3">
        ...
        <form onSubmit={onSubmit}>
          ...
          <button type="submit" className="bg-transparent hover:bg-blue-500 text-blue-700 font-bold hover:text-white py-1 border border-blue-500 hover:border-transparent rounded">
            Update Password
          </button>
        </form>
      </div>
